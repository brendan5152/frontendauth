...
<div align="center">
  ...
  <h3 align="center">PARTY/EVENT APP BABY</h3>
...
1. Go to Feestapp/frontend and run 'npm install' 
2. Go to Feestapp/backend and run 'pip install -r requirements.txt'
...
- [ ] Merge the Login and register logic into the Merge Branch from gijs-test-branch
- [ ] Merge the Merge branch into Main
- [ ] Add Pages
    - [ ] Login
    - [ ] Register
    - [ ] User Settings
...
Project Link: [https://github.com/GijsSi/FeestApp](https://github.com//GijsSi/FeestApp)
